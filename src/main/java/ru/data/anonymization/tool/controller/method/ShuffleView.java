...
import ru.data.anonymization.tool.methods.options.type.Shuffle;
...
public class ShuffleView {
    ...
    public void configView(String title, String table, ShowMode mode, String name, VBox vBox) throws IOException {
        FXMLLoader fxmlLoader = new FXMLLoader(ShuffleView.class.getResource("shuffle-view.fxml"));
